                ...
                return (
                  <TableRow className={abnormalClassName} key={device.ieee}>
                    ...
                    <TableCell className="text-x">
                      {device.has_low_lqi ? (
                        <b className="text-red-600">{lqiName}</b>
                      ) : (
                        <p>{lqiName}</p>
                      )}
                    </TableCell>
                    ...
                    <TableCell className="text-xs text-right">
                      <TimeAgo
                        ...
                        now={() => new Date(observations[0].timestamp).getTime()}
                      />
                    </TableCell>
                    ...
                    <TableCell className="text-xs w-0.5 text-right">
                      {device.integration_type.toUpperCase()}
                    </TableCell>
                  </TableRow>
                );
              })}
