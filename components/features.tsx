        ...
        <div id="features" className="py-16 bg-gray-100 dark:bg-gray-800">
          <div className="container mx-auto px-4">
            <div className="text-center pb-12">
              <h2 className="text-4xl font-semibold text-gray-800 dark:text-white">Powerful Features</h2>
            ...
            <div className="flex flex-wrap justify-center text-center">
              {features.map((feature, index) => (
                <div key={index} className="w-full sm:w-1/2 md:w-1/3 xl:w-1/4 px-4 mb-8">
                  <div className="px-6 py-8 rounded-lg bg-white dark:bg-gray-700 shadow-lg">
                    <div className="mb-4 flex justify-center text-gray-800 dark:text-gray-300">{feature.icon}</div>
                    <h5 className="text-xl font-semibold mb-4 text-gray-800 dark:text-white">{feature.title}</h5>
